define(
    ...
    function() {
        ...
        // route object - DOES THIS NEED TO IN THIS CLASS?
        var routeObject = {
            distance: 0,
            duration: 0,
            currentStep: 0
        ...
        // getDuration - function to return the duration of the current route
        var getDuration = function() {
            return routeObject.duration;
        };
        
        // clearDirections - function to clear the current direction
        var clearDirections = function() {
            routeObject.distance = 0;
            routeObject.duration = 0;
            routeObject.currentStep = 0;
        };
        ...
        var processDirections = function(directions, callback) {
        ...
        // dhm - outputs dd:hh:mm for the passed in amount of milliseconds
        var dhm = function(t){
